...
export type ShaderUniforms<TVars extends GlslVarsInfo<string, 'uniform'>> = {
  [K in keyof TVars & string]: TVars[K] extends { type: keyof (UniformSetterArgs & UniformSetterArrayArgs) } //
    ? ShaderUniform<TVars[K]['type']>
    : never
}

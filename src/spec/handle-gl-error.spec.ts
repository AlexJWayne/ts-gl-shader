...
describe('handleGlError', () => {
  ...
  describe('when there is an error', () => {
    ...
    it('console logs the error', () => {
      expect(console.error).toHaveBeenCalledWith('WebGL Error: 1281 INVALID_VALUE')
    })
  })
  ...
  describe('when there is an error and a name', () => {
    ...
    it('console logs the error', () => {
      expect(console.error).toHaveBeenCalledWith('WebGL Error: rendering my thing 1281 INVALID_VALUE')
    })
  })
})

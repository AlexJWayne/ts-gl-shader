  ...
  describe('uniforms', () => {
    describe('matrices', () => {
      testUniform(
        ...
        (shaderProgram) => {
          expectTypeOf(shaderProgram.uniforms.uMat2).toEqualTypeOf<{
            type: 'mat2'
      ...
      testUniform(
        ...
        (shaderProgram) => {
          expectTypeOf(shaderProgram.uniforms.uMat3).toEqualTypeOf<{
            type: 'mat3'
            location: WebGLUniformLocation
            setArray: (
              array:
      ...
      testUniform(
        ...
        (shaderProgram) => {
          expectTypeOf(shaderProgram.uniforms.uMat4).toEqualTypeOf<{
            type: 'mat4'
            location: WebGLUniformLocation
            setArray: (
              array:
